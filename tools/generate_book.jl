...
function html_header(section::Section)
    ...
    let
        ...
        title = $(repr(section.name))
        youtubeid = $(repr(section.video_id))
        \"\"\"
        <div class="morebackground"></div>
        
        <div class="lecture-banner">
        
        <p class="banner-section-number">
        <em>Section \$(chapter).\$(section)</em>
        </p>
        
        <p class="banner-section-title">
        <em>\$(title)</em>
        </p>
        
        <p class="lecture-video">
        <em>Lecture Video</em>
        </p>
        
        <div class="lecture-video" style="display: flex; justify-content: center;">
        <div  notthestyle="position: relative; right: 0; top: 0; z-index: 300;">
        <iframe src="https://www.youtube.com/embed/\$(youtubeid)" width=400 height=250  frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
        </div>
        </div>
        ...
        p.banner-section-number {
        font-size: 1.5rem;
        opacity: .8;
        }
        p.banner-section-title {
