# First-time setup: _Install Julia & Pluto_
...
_Make sure that you are able to launch Julia and calculate `1+1` before proceeding!_
...
To install Pluto, run the following (case sensitive) command to _add_ (install) the package to your system by downloading it from the internet.
You should only need to do this _once_ for each installation of Julia:
...
For example, homework 0 is available [here](https://github.com/mitmath/18S191/blob/Fall20/homework/homework0/hw0.jl). Copy this link (right click -> Copy Link), and paste it into the box. Press ENTER, and select OK in the confirmation box.
