...
|--|--|--|--|
|HW0 (not graded) | Thursday 3 September |  <ul> <li>[Homework 0 Set up Julia and Pluto (Part 1)][md:setup] </li> <li>[The notebook (static view)](https://htmlpreview.github.io/?https://github.com/mitmath/18S191/blob/master/homework/homework0/hw0.html) </ul> | <ul> <li>[The Pluto notebook][md:hw0]</li> </ul> | 
